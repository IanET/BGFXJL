...
const BGFX_SYMBOL_IMPORT = dllimport
const BGFX_C_API = BGFX_SHARED_LIB_API
const BGFX_API_VERSION = UINT32_C(109)
const BGFX_STATE_WRITE_R = UINT64_C(0x0000000000000001)
const BGFX_STATE_WRITE_G = UINT64_C(0x0000000000000002)
const BGFX_STATE_WRITE_B = UINT64_C(0x0000000000000004)
const BGFX_STATE_WRITE_A = UINT64_C(0x0000000000000008)
const BGFX_STATE_WRITE_Z = UINT64_C(0x0000004000000000)
...
const BGFX_STATE_DEPTH_TEST_LESS = UINT64_C(0x0000000000000010)
const BGFX_STATE_DEPTH_TEST_LEQUAL = UINT64_C(0x0000000000000020)
const BGFX_STATE_DEPTH_TEST_EQUAL = UINT64_C(0x0000000000000030)
const BGFX_STATE_DEPTH_TEST_GEQUAL = UINT64_C(0x0000000000000040)
const BGFX_STATE_DEPTH_TEST_GREATER = UINT64_C(0x0000000000000050)
const BGFX_STATE_DEPTH_TEST_NOTEQUAL = UINT64_C(0x0000000000000060)
const BGFX_STATE_DEPTH_TEST_NEVER = UINT64_C(0x0000000000000070)
const BGFX_STATE_DEPTH_TEST_ALWAYS = UINT64_C(0x0000000000000080)
const BGFX_STATE_DEPTH_TEST_SHIFT = 4
const BGFX_STATE_DEPTH_TEST_MASK = UINT64_C(0x00000000000000f0)
const BGFX_STATE_BLEND_ZERO = UINT64_C(0x0000000000001000)
const BGFX_STATE_BLEND_ONE = UINT64_C(0x0000000000002000)
const BGFX_STATE_BLEND_SRC_COLOR = UINT64_C(0x0000000000003000)
const BGFX_STATE_BLEND_INV_SRC_COLOR = UINT64_C(0x0000000000004000)
const BGFX_STATE_BLEND_SRC_ALPHA = UINT64_C(0x0000000000005000)
const BGFX_STATE_BLEND_INV_SRC_ALPHA = UINT64_C(0x0000000000006000)
const BGFX_STATE_BLEND_DST_ALPHA = UINT64_C(0x0000000000007000)
const BGFX_STATE_BLEND_INV_DST_ALPHA = UINT64_C(0x0000000000008000)
const BGFX_STATE_BLEND_DST_COLOR = UINT64_C(0x0000000000009000)
const BGFX_STATE_BLEND_INV_DST_COLOR = UINT64_C(0x000000000000a000)
const BGFX_STATE_BLEND_SRC_ALPHA_SAT = UINT64_C(0x000000000000b000)
const BGFX_STATE_BLEND_FACTOR = UINT64_C(0x000000000000c000)
const BGFX_STATE_BLEND_INV_FACTOR = UINT64_C(0x000000000000d000)
const BGFX_STATE_BLEND_SHIFT = 12
const BGFX_STATE_BLEND_MASK = UINT64_C(0x000000000ffff000)
const BGFX_STATE_BLEND_EQUATION_ADD = UINT64_C(0x0000000000000000)
const BGFX_STATE_BLEND_EQUATION_SUB = UINT64_C(0x0000000010000000)
const BGFX_STATE_BLEND_EQUATION_REVSUB = UINT64_C(0x0000000020000000)
const BGFX_STATE_BLEND_EQUATION_MIN = UINT64_C(0x0000000030000000)
const BGFX_STATE_BLEND_EQUATION_MAX = UINT64_C(0x0000000040000000)
const BGFX_STATE_BLEND_EQUATION_SHIFT = 28
const BGFX_STATE_BLEND_EQUATION_MASK = UINT64_C(0x00000003f0000000)
const BGFX_STATE_CULL_CW = UINT64_C(0x0000001000000000)
const BGFX_STATE_CULL_CCW = UINT64_C(0x0000002000000000)
const BGFX_STATE_CULL_SHIFT = 36
const BGFX_STATE_CULL_MASK = UINT64_C(0x0000003000000000)
const BGFX_STATE_ALPHA_REF_SHIFT = 40
const BGFX_STATE_ALPHA_REF_MASK = UINT64_C(0x0000ff0000000000)

# Skipping MacroDefinition: BGFX_STATE_ALPHA_REF ( v ) ( ( ( uint64_t ) ( v ) << BGFX_STATE_ALPHA_REF_SHIFT ) & BGFX_STATE_ALPHA_REF_MASK )

const BGFX_STATE_PT_TRISTRIP = UINT64_C(0x0001000000000000)
const BGFX_STATE_PT_LINES = UINT64_C(0x0002000000000000)
const BGFX_STATE_PT_LINESTRIP = UINT64_C(0x0003000000000000)
const BGFX_STATE_PT_POINTS = UINT64_C(0x0004000000000000)
const BGFX_STATE_PT_SHIFT = 48
const BGFX_STATE_PT_MASK = UINT64_C(0x0007000000000000)
const BGFX_STATE_POINT_SIZE_SHIFT = 52
const BGFX_STATE_POINT_SIZE_MASK = UINT64_C(0x00f0000000000000)

# Skipping MacroDefinition: BGFX_STATE_POINT_SIZE ( v ) ( ( ( uint64_t ) ( v ) << BGFX_STATE_POINT_SIZE_SHIFT ) & BGFX_STATE_POINT_SIZE_MASK )

const BGFX_STATE_MSAA = UINT64_C(0x0100000000000000)
const BGFX_STATE_LINEAA = UINT64_C(0x0200000000000000)
const BGFX_STATE_CONSERVATIVE_RASTER = UINT64_C(0x0400000000000000)
const BGFX_STATE_NONE = UINT64_C(0x0000000000000000)
const BGFX_STATE_FRONT_CCW = UINT64_C(0x0000008000000000)
const BGFX_STATE_BLEND_INDEPENDENT = UINT64_C(0x0000000400000000)
const BGFX_STATE_BLEND_ALPHA_TO_COVERAGE = UINT64_C(0x0000000800000000)
...
const BGFX_STATE_MASK = UINT64_C(0xffffffffffffffff)
const BGFX_STATE_RESERVED_SHIFT = 61
const BGFX_STATE_RESERVED_MASK = UINT64_C(0xe000000000000000)
const BGFX_STENCIL_FUNC_REF_SHIFT = 0
const BGFX_STENCIL_FUNC_REF_MASK = UINT32_C(0x000000ff)
...
const BGFX_STENCIL_FUNC_RMASK_MASK = UINT32_C(0x0000ff00)

# Skipping MacroDefinition: BGFX_STENCIL_FUNC_RMASK ( v ) ( ( ( uint32_t ) ( v ) << BGFX_STENCIL_FUNC_RMASK_SHIFT ) & BGFX_STENCIL_FUNC_RMASK_MASK )

const BGFX_STENCIL_NONE = UINT32_C(0x00000000)
const BGFX_STENCIL_MASK = UINT32_C(0xffffffff)
const BGFX_STENCIL_DEFAULT = UINT32_C(0x00000000)
const BGFX_STENCIL_TEST_LESS = UINT32_C(0x00010000)
const BGFX_STENCIL_TEST_LEQUAL = UINT32_C(0x00020000)
const BGFX_STENCIL_TEST_EQUAL = UINT32_C(0x00030000)
const BGFX_STENCIL_TEST_GEQUAL = UINT32_C(0x00040000)
const BGFX_STENCIL_TEST_GREATER = UINT32_C(0x00050000)
const BGFX_STENCIL_TEST_NOTEQUAL = UINT32_C(0x00060000)
const BGFX_STENCIL_TEST_NEVER = UINT32_C(0x00070000)
const BGFX_STENCIL_TEST_ALWAYS = UINT32_C(0x00080000)
const BGFX_STENCIL_TEST_SHIFT = 16
const BGFX_STENCIL_TEST_MASK = UINT32_C(0x000f0000)
const BGFX_STENCIL_OP_FAIL_S_ZERO = UINT32_C(0x00000000)
const BGFX_STENCIL_OP_FAIL_S_KEEP = UINT32_C(0x00100000)
const BGFX_STENCIL_OP_FAIL_S_REPLACE = UINT32_C(0x00200000)
const BGFX_STENCIL_OP_FAIL_S_INCR = UINT32_C(0x00300000)
const BGFX_STENCIL_OP_FAIL_S_INCRSAT = UINT32_C(0x00400000)
const BGFX_STENCIL_OP_FAIL_S_DECR = UINT32_C(0x00500000)
const BGFX_STENCIL_OP_FAIL_S_DECRSAT = UINT32_C(0x00600000)
const BGFX_STENCIL_OP_FAIL_S_INVERT = UINT32_C(0x00700000)
const BGFX_STENCIL_OP_FAIL_S_SHIFT = 20
const BGFX_STENCIL_OP_FAIL_S_MASK = UINT32_C(0x00f00000)
const BGFX_STENCIL_OP_FAIL_Z_ZERO = UINT32_C(0x00000000)
const BGFX_STENCIL_OP_FAIL_Z_KEEP = UINT32_C(0x01000000)
const BGFX_STENCIL_OP_FAIL_Z_REPLACE = UINT32_C(0x02000000)
const BGFX_STENCIL_OP_FAIL_Z_INCR = UINT32_C(0x03000000)
const BGFX_STENCIL_OP_FAIL_Z_INCRSAT = UINT32_C(0x04000000)
const BGFX_STENCIL_OP_FAIL_Z_DECR = UINT32_C(0x05000000)
const BGFX_STENCIL_OP_FAIL_Z_DECRSAT = UINT32_C(0x06000000)
const BGFX_STENCIL_OP_FAIL_Z_INVERT = UINT32_C(0x07000000)
const BGFX_STENCIL_OP_FAIL_Z_SHIFT = 24
const BGFX_STENCIL_OP_FAIL_Z_MASK = UINT32_C(0x0f000000)
const BGFX_STENCIL_OP_PASS_Z_ZERO = UINT32_C(0x00000000)
const BGFX_STENCIL_OP_PASS_Z_KEEP = UINT32_C(0x10000000)
const BGFX_STENCIL_OP_PASS_Z_REPLACE = UINT32_C(0x20000000)
const BGFX_STENCIL_OP_PASS_Z_INCR = UINT32_C(0x30000000)
const BGFX_STENCIL_OP_PASS_Z_INCRSAT = UINT32_C(0x40000000)
const BGFX_STENCIL_OP_PASS_Z_DECR = UINT32_C(0x50000000)
const BGFX_STENCIL_OP_PASS_Z_DECRSAT = UINT32_C(0x60000000)
const BGFX_STENCIL_OP_PASS_Z_INVERT = UINT32_C(0x70000000)
const BGFX_STENCIL_OP_PASS_Z_SHIFT = 28
const BGFX_STENCIL_OP_PASS_Z_MASK = UINT32_C(0xf0000000)
const BGFX_CLEAR_NONE = UINT16_C(0x0000)
const BGFX_CLEAR_COLOR = UINT16_C(0x0001)
const BGFX_CLEAR_DEPTH = UINT16_C(0x0002)
const BGFX_CLEAR_STENCIL = UINT16_C(0x0004)
const BGFX_CLEAR_DISCARD_COLOR_0 = UINT16_C(0x0008)
const BGFX_CLEAR_DISCARD_COLOR_1 = UINT16_C(0x0010)
const BGFX_CLEAR_DISCARD_COLOR_2 = UINT16_C(0x0020)
const BGFX_CLEAR_DISCARD_COLOR_3 = UINT16_C(0x0040)
const BGFX_CLEAR_DISCARD_COLOR_4 = UINT16_C(0x0080)
const BGFX_CLEAR_DISCARD_COLOR_5 = UINT16_C(0x0100)
const BGFX_CLEAR_DISCARD_COLOR_6 = UINT16_C(0x0200)
const BGFX_CLEAR_DISCARD_COLOR_7 = UINT16_C(0x0400)
const BGFX_CLEAR_DISCARD_DEPTH = UINT16_C(0x0800)
const BGFX_CLEAR_DISCARD_STENCIL = UINT16_C(0x1000)
...
const BGFX_DISCARD_NONE = UINT8_C(0x00)
const BGFX_DISCARD_BINDINGS = UINT8_C(0x01)
const BGFX_DISCARD_INDEX_BUFFER = UINT8_C(0x02)
const BGFX_DISCARD_INSTANCE_DATA = UINT8_C(0x04)
const BGFX_DISCARD_STATE = UINT8_C(0x08)
const BGFX_DISCARD_TRANSFORM = UINT8_C(0x10)
const BGFX_DISCARD_VERTEX_STREAMS = UINT8_C(0x20)
const BGFX_DISCARD_ALL = UINT8_C(0xff)
const BGFX_DEBUG_NONE = UINT32_C(0x00000000)
const BGFX_DEBUG_WIREFRAME = UINT32_C(0x00000001)
const BGFX_DEBUG_IFH = UINT32_C(0x00000002)
const BGFX_DEBUG_STATS = UINT32_C(0x00000004)
const BGFX_DEBUG_TEXT = UINT32_C(0x00000008)
const BGFX_DEBUG_PROFILER = UINT32_C(0x00000010)
const BGFX_BUFFER_COMPUTE_FORMAT_8X1 = UINT16_C(0x0001)
const BGFX_BUFFER_COMPUTE_FORMAT_8X2 = UINT16_C(0x0002)
const BGFX_BUFFER_COMPUTE_FORMAT_8X4 = UINT16_C(0x0003)
const BGFX_BUFFER_COMPUTE_FORMAT_16X1 = UINT16_C(0x0004)
const BGFX_BUFFER_COMPUTE_FORMAT_16X2 = UINT16_C(0x0005)
const BGFX_BUFFER_COMPUTE_FORMAT_16X4 = UINT16_C(0x0006)
const BGFX_BUFFER_COMPUTE_FORMAT_32X1 = UINT16_C(0x0007)
const BGFX_BUFFER_COMPUTE_FORMAT_32X2 = UINT16_C(0x0008)
const BGFX_BUFFER_COMPUTE_FORMAT_32X4 = UINT16_C(0x0009)
const BGFX_BUFFER_COMPUTE_FORMAT_SHIFT = 0
const BGFX_BUFFER_COMPUTE_FORMAT_MASK = UINT16_C(0x000f)
const BGFX_BUFFER_COMPUTE_TYPE_INT = UINT16_C(0x0010)
const BGFX_BUFFER_COMPUTE_TYPE_UINT = UINT16_C(0x0020)
const BGFX_BUFFER_COMPUTE_TYPE_FLOAT = UINT16_C(0x0030)
const BGFX_BUFFER_COMPUTE_TYPE_SHIFT = 4
const BGFX_BUFFER_COMPUTE_TYPE_MASK = UINT16_C(0x0030)
const BGFX_BUFFER_NONE = UINT16_C(0x0000)
const BGFX_BUFFER_COMPUTE_READ = UINT16_C(0x0100)
const BGFX_BUFFER_COMPUTE_WRITE = UINT16_C(0x0200)
const BGFX_BUFFER_DRAW_INDIRECT = UINT16_C(0x0400)
const BGFX_BUFFER_ALLOW_RESIZE = UINT16_C(0x0800)
const BGFX_BUFFER_INDEX32 = UINT16_C(0x1000)
const BGFX_BUFFER_COMPUTE_READ_WRITE = (0 | BGFX_BUFFER_COMPUTE_READ) | BGFX_BUFFER_COMPUTE_WRITE
const BGFX_TEXTURE_NONE = UINT64_C(0x0000000000000000)
const BGFX_TEXTURE_MSAA_SAMPLE = UINT64_C(0x0000000800000000)
const BGFX_TEXTURE_RT = UINT64_C(0x0000001000000000)
const BGFX_TEXTURE_COMPUTE_WRITE = UINT64_C(0x0000100000000000)
const BGFX_TEXTURE_SRGB = UINT64_C(0x0000200000000000)
const BGFX_TEXTURE_BLIT_DST = UINT64_C(0x0000400000000000)
const BGFX_TEXTURE_READ_BACK = UINT64_C(0x0000800000000000)
const BGFX_TEXTURE_RT_MSAA_X2 = UINT64_C(0x0000002000000000)
const BGFX_TEXTURE_RT_MSAA_X4 = UINT64_C(0x0000003000000000)
const BGFX_TEXTURE_RT_MSAA_X8 = UINT64_C(0x0000004000000000)
const BGFX_TEXTURE_RT_MSAA_X16 = UINT64_C(0x0000005000000000)
const BGFX_TEXTURE_RT_MSAA_SHIFT = 36
const BGFX_TEXTURE_RT_MSAA_MASK = UINT64_C(0x0000007000000000)
const BGFX_TEXTURE_RT_WRITE_ONLY = UINT64_C(0x0000008000000000)
const BGFX_TEXTURE_RT_SHIFT = 36
const BGFX_TEXTURE_RT_MASK = UINT64_C(0x000000f000000000)
const BGFX_SAMPLER_U_MIRROR = UINT32_C(0x00000001)
const BGFX_SAMPLER_U_CLAMP = UINT32_C(0x00000002)
const BGFX_SAMPLER_U_BORDER = UINT32_C(0x00000003)
const BGFX_SAMPLER_U_SHIFT = 0
const BGFX_SAMPLER_U_MASK = UINT32_C(0x00000003)
const BGFX_SAMPLER_V_MIRROR = UINT32_C(0x00000004)
const BGFX_SAMPLER_V_CLAMP = UINT32_C(0x00000008)
const BGFX_SAMPLER_V_BORDER = UINT32_C(0x0000000c)
const BGFX_SAMPLER_V_SHIFT = 2
const BGFX_SAMPLER_V_MASK = UINT32_C(0x0000000c)
const BGFX_SAMPLER_W_MIRROR = UINT32_C(0x00000010)
const BGFX_SAMPLER_W_CLAMP = UINT32_C(0x00000020)
const BGFX_SAMPLER_W_BORDER = UINT32_C(0x00000030)
const BGFX_SAMPLER_W_SHIFT = 4
const BGFX_SAMPLER_W_MASK = UINT32_C(0x00000030)
const BGFX_SAMPLER_MIN_POINT = UINT32_C(0x00000040)
const BGFX_SAMPLER_MIN_ANISOTROPIC = UINT32_C(0x00000080)
const BGFX_SAMPLER_MIN_SHIFT = 6
const BGFX_SAMPLER_MIN_MASK = UINT32_C(0x000000c0)
const BGFX_SAMPLER_MAG_POINT = UINT32_C(0x00000100)
const BGFX_SAMPLER_MAG_ANISOTROPIC = UINT32_C(0x00000200)
const BGFX_SAMPLER_MAG_SHIFT = 8
const BGFX_SAMPLER_MAG_MASK = UINT32_C(0x00000300)
const BGFX_SAMPLER_MIP_POINT = UINT32_C(0x00000400)
const BGFX_SAMPLER_MIP_SHIFT = 10
const BGFX_SAMPLER_MIP_MASK = UINT32_C(0x00000400)
const BGFX_SAMPLER_COMPARE_LESS = UINT32_C(0x00010000)
const BGFX_SAMPLER_COMPARE_LEQUAL = UINT32_C(0x00020000)
const BGFX_SAMPLER_COMPARE_EQUAL = UINT32_C(0x00030000)
const BGFX_SAMPLER_COMPARE_GEQUAL = UINT32_C(0x00040000)
const BGFX_SAMPLER_COMPARE_GREATER = UINT32_C(0x00050000)
const BGFX_SAMPLER_COMPARE_NOTEQUAL = UINT32_C(0x00060000)
const BGFX_SAMPLER_COMPARE_NEVER = UINT32_C(0x00070000)
const BGFX_SAMPLER_COMPARE_ALWAYS = UINT32_C(0x00080000)
const BGFX_SAMPLER_COMPARE_SHIFT = 16
const BGFX_SAMPLER_COMPARE_MASK = UINT32_C(0x000f0000)
const BGFX_SAMPLER_BORDER_COLOR_SHIFT = 24
const BGFX_SAMPLER_BORDER_COLOR_MASK = UINT32_C(0x0f000000)
...
const BGFX_SAMPLER_RESERVED_MASK = UINT32_C(0xf0000000)
const BGFX_SAMPLER_NONE = UINT32_C(0x00000000)
const BGFX_SAMPLER_SAMPLE_STENCIL = UINT32_C(0x00100000)
...
const BGFX_RESET_MSAA_X2 = UINT32_C(0x00000010)
const BGFX_RESET_MSAA_X4 = UINT32_C(0x00000020)
const BGFX_RESET_MSAA_X8 = UINT32_C(0x00000030)
const BGFX_RESET_MSAA_X16 = UINT32_C(0x00000040)
const BGFX_RESET_MSAA_SHIFT = 4
const BGFX_RESET_MSAA_MASK = UINT32_C(0x00000070)
const BGFX_RESET_NONE = UINT32_C(0x00000000)
const BGFX_RESET_FULLSCREEN = UINT32_C(0x00000001)
const BGFX_RESET_VSYNC = UINT32_C(0x00000080)
const BGFX_RESET_MAXANISOTROPY = UINT32_C(0x00000100)
const BGFX_RESET_CAPTURE = UINT32_C(0x00000200)
const BGFX_RESET_FLUSH_AFTER_RENDER = UINT32_C(0x00002000)
const BGFX_RESET_FLIP_AFTER_RENDER = UINT32_C(0x00004000)
const BGFX_RESET_SRGB_BACKBUFFER = UINT32_C(0x00008000)
const BGFX_RESET_HDR10 = UINT32_C(0x00010000)
const BGFX_RESET_HIDPI = UINT32_C(0x00020000)
const BGFX_RESET_DEPTH_CLAMP = UINT32_C(0x00040000)
const BGFX_RESET_SUSPEND = UINT32_C(0x00080000)
const BGFX_RESET_FULLSCREEN_SHIFT = 0
const BGFX_RESET_FULLSCREEN_MASK = UINT32_C(0x00000001)
const BGFX_RESET_RESERVED_SHIFT = 31
const BGFX_RESET_RESERVED_MASK = UINT32_C(0x80000000)
const BGFX_CAPS_ALPHA_TO_COVERAGE = UINT64_C(0x0000000000000001)
const BGFX_CAPS_BLEND_INDEPENDENT = UINT64_C(0x0000000000000002)
const BGFX_CAPS_COMPUTE = UINT64_C(0x0000000000000004)
const BGFX_CAPS_CONSERVATIVE_RASTER = UINT64_C(0x0000000000000008)
const BGFX_CAPS_DRAW_INDIRECT = UINT64_C(0x0000000000000010)
const BGFX_CAPS_FRAGMENT_DEPTH = UINT64_C(0x0000000000000020)
const BGFX_CAPS_FRAGMENT_ORDERING = UINT64_C(0x0000000000000040)
const BGFX_CAPS_IMAGE_RW = UINT64_C(0x0000000000000080)
const BGFX_CAPS_GRAPHICS_DEBUGGER = UINT64_C(0x0000000000000100)
const BGFX_CAPS_RESERVED = UINT64_C(0x0000000000000200)
const BGFX_CAPS_HDR10 = UINT64_C(0x0000000000000400)
const BGFX_CAPS_HIDPI = UINT64_C(0x0000000000000800)
const BGFX_CAPS_INDEX32 = UINT64_C(0x0000000000001000)
const BGFX_CAPS_INSTANCING = UINT64_C(0x0000000000002000)
const BGFX_CAPS_OCCLUSION_QUERY = UINT64_C(0x0000000000004000)
const BGFX_CAPS_RENDERER_MULTITHREADED = UINT64_C(0x0000000000008000)
const BGFX_CAPS_SWAP_CHAIN = UINT64_C(0x0000000000010000)
const BGFX_CAPS_TEXTURE_2D_ARRAY = UINT64_C(0x0000000000020000)
const BGFX_CAPS_TEXTURE_3D = UINT64_C(0x0000000000040000)
const BGFX_CAPS_TEXTURE_BLIT = UINT64_C(0x0000000000080000)
const BGFX_CAPS_TEXTURE_COMPARE_RESERVED = UINT64_C(0x0000000000100000)
const BGFX_CAPS_TEXTURE_COMPARE_LEQUAL = UINT64_C(0x0000000000200000)
const BGFX_CAPS_TEXTURE_CUBE_ARRAY = UINT64_C(0x0000000000400000)
const BGFX_CAPS_TEXTURE_DIRECT_ACCESS = UINT64_C(0x0000000000800000)
const BGFX_CAPS_TEXTURE_READ_BACK = UINT64_C(0x0000000001000000)
const BGFX_CAPS_VERTEX_ATTRIB_HALF = UINT64_C(0x0000000002000000)
const BGFX_CAPS_VERTEX_ATTRIB_UINT10 = UINT64_C(0x0000000004000000)
const BGFX_CAPS_VERTEX_ID = UINT64_C(0x0000000008000000)
const BGFX_CAPS_TEXTURE_COMPARE_ALL = (0 | BGFX_CAPS_TEXTURE_COMPARE_RESERVED) | BGFX_CAPS_TEXTURE_COMPARE_LEQUAL
const BGFX_CAPS_FORMAT_TEXTURE_NONE = UINT32_C(0x00000000)
const BGFX_CAPS_FORMAT_TEXTURE_2D = UINT32_C(0x00000001)
const BGFX_CAPS_FORMAT_TEXTURE_2D_SRGB = UINT32_C(0x00000002)
const BGFX_CAPS_FORMAT_TEXTURE_2D_EMULATED = UINT32_C(0x00000004)
const BGFX_CAPS_FORMAT_TEXTURE_3D = UINT32_C(0x00000008)
const BGFX_CAPS_FORMAT_TEXTURE_3D_SRGB = UINT32_C(0x00000010)
const BGFX_CAPS_FORMAT_TEXTURE_3D_EMULATED = UINT32_C(0x00000020)
const BGFX_CAPS_FORMAT_TEXTURE_CUBE = UINT32_C(0x00000040)
const BGFX_CAPS_FORMAT_TEXTURE_CUBE_SRGB = UINT32_C(0x00000080)
const BGFX_CAPS_FORMAT_TEXTURE_CUBE_EMULATED = UINT32_C(0x00000100)
const BGFX_CAPS_FORMAT_TEXTURE_VERTEX = UINT32_C(0x00000200)
const BGFX_CAPS_FORMAT_TEXTURE_IMAGE_READ = UINT32_C(0x00000400)
const BGFX_CAPS_FORMAT_TEXTURE_IMAGE_WRITE = UINT32_C(0x00000800)
const BGFX_CAPS_FORMAT_TEXTURE_FRAMEBUFFER = UINT32_C(0x00001000)
const BGFX_CAPS_FORMAT_TEXTURE_FRAMEBUFFER_MSAA = UINT32_C(0x00002000)
const BGFX_CAPS_FORMAT_TEXTURE_MSAA = UINT32_C(0x00004000)
const BGFX_CAPS_FORMAT_TEXTURE_MIP_AUTOGEN = UINT32_C(0x00008000)
const BGFX_RESOLVE_NONE = UINT8_C(0x00)
const BGFX_RESOLVE_AUTO_GEN_MIPS = UINT8_C(0x01)
const BGFX_PCI_ID_NONE = UINT16_C(0x0000)
const BGFX_PCI_ID_SOFTWARE_RASTERIZER = UINT16_C(0x0001)
const BGFX_PCI_ID_AMD = UINT16_C(0x1002)
const BGFX_PCI_ID_INTEL = UINT16_C(0x8086)
const BGFX_PCI_ID_NVIDIA = UINT16_C(0x10de)
const BGFX_CUBE_MAP_POSITIVE_X = UINT8_C(0x00)
const BGFX_CUBE_MAP_NEGATIVE_X = UINT8_C(0x01)
const BGFX_CUBE_MAP_POSITIVE_Y = UINT8_C(0x02)
const BGFX_CUBE_MAP_NEGATIVE_Y = UINT8_C(0x03)
const BGFX_CUBE_MAP_POSITIVE_Z = UINT8_C(0x04)
const BGFX_CUBE_MAP_NEGATIVE_Z = UINT8_C(0x05)
...
const BGFX_STATE_BLEND_FUNC(_src, _dst) = begin
            #= none:1 =#
            BGFX_STATE_BLEND_FUNC_SEPARATE(_src, _dst, _src, _dst)
        end
const BGFX_STATE_BLEND_EQUATION(_equation) = begin
            #= none:1 =#
            BGFX_STATE_BLEND_EQUATION_SEPARATE(_equation, _equation)
        end
const BGFX_STATE_BLEND_ADD = 0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_ONE, BGFX_STATE_BLEND_ONE)
const BGFX_STATE_BLEND_ALPHA = 0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
const BGFX_STATE_BLEND_DARKEN = (0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_ONE, BGFX_STATE_BLEND_ONE)) | BGFX_STATE_BLEND_EQUATION(BGFX_STATE_BLEND_EQUATION_MIN)
const BGFX_STATE_BLEND_LIGHTEN = (0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_ONE, BGFX_STATE_BLEND_ONE)) | BGFX_STATE_BLEND_EQUATION(BGFX_STATE_BLEND_EQUATION_MAX)
const BGFX_STATE_BLEND_MULTIPLY = 0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_DST_COLOR, BGFX_STATE_BLEND_ZERO)
const BGFX_STATE_BLEND_NORMAL = 0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_ONE, BGFX_STATE_BLEND_INV_SRC_ALPHA)
const BGFX_STATE_BLEND_SCREEN = 0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_ONE, BGFX_STATE_BLEND_INV_SRC_COLOR)
const BGFX_STATE_BLEND_LINEAR_BURN = (0 | BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_DST_COLOR, BGFX_STATE_BLEND_INV_DST_COLOR)) | BGFX_STATE_BLEND_EQUATION(BGFX_STATE_BLEND_EQUATION_SUB)
